...
import 'package:project_tetholiday/viewmodels/home/main_home_viewmodel.dart';
import 'package:project_tetholiday/views/feast/feast_library_page.dart';
import 'package:project_tetholiday/views/recipe/recipe_list_by_occasion_page.dart';
import 'package:project_tetholiday/views/recipe/recipe_search_page.dart';
import 'package:project_tetholiday/views/feast/feast_planner_page.dart';
...
class _MainHomeContentState extends State<MainHomeContent> {
  ...
  late MainHomeViewModel _viewModel;

  @override
  void initState() {
    super.initState();
    _viewModel = MainHomeViewModel();
    widget.onRegisterRefresh?.call(_viewModel.loadFeastCards);
  }
        ...
        return Container(
          ...
          child: CustomScrollView(
            slivers: [
              ...
              SliverToBoxAdapter(child: _buildAIPlannerBanner(context, isDark)),
              const SliverToBoxAdapter(child: SizedBox(height: 24)),
        ...
        child: IgnorePointer(
          child: TextField(
            decoration: InputDecoration(
              ...
              suffixIcon: Icon(Icons.filter_list, color: _primary.withValues(alpha:0.5), size: 22),
              filled: true,
  ...
  Widget _buildFeastCards(BuildContext context) {
    if (_viewModel.isLoadingFeasts) {
      return const Center(child: CircularProgressIndicator());
    }
    if (_viewModel.feastCards.isEmpty) {
      return const SizedBox.shrink();
    }
    final list = _viewModel.feastCards;
    return Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16),
          child: Column(
  ...
  Widget _buildAIPlannerBanner(BuildContext context, bool isDark) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16),
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute<void>(
                builder: (context) => const FeastPlannerPage(),
              ),
            );
          },
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  _primary.withValues(alpha:isDark ? 0.3 : 0.8),
                  _primary.withValues(alpha:isDark ? 0.1 : 0.6),
                ],
              ...
              boxShadow: [
                BoxShadow(
                  color: _primary.withValues(alpha:isDark ? 0 : 0.2),
                  blurRadius: 10,
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Lên thực đơn siêu tốc vừa khít với túi tiền gia đình.',
                        style: GoogleFonts.plusJakartaSans(
                          fontSize: 14,
              ...
              children: [
                Row(
                  children: [
                    ...
                    Icon(Icons.menu_book, color: _primary.withValues(alpha:0.2), size: 56),
                  ],
                ),
                Positioned(
                  right: -8,
                  bottom: -8,
                  child: Icon(Icons.local_florist, color: _primary.withValues(alpha:0.1), size: 72),
                ),
              ],
            ),
          ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: _primary.withValues(alpha:0.3), blurRadius: 8, offset: const Offset(0, 2))],
              ),
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
